db.getCollection('users_recommended_view').find({})

//DML
db.getCollection('users_recommended_view').insertMany(
    [
        { 
            username: "mara.djo", 
            dob: "19.05.1997.",
            ...
            //turn ons plus lista interesovanja ili nakon matchovanja da vratimo sta im je u preseku
            gender: "o",
            location: "BEOGRAD"
        },
